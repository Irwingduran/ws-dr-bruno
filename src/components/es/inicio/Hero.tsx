...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Bruno Rubí López es considerado un joven cirujano prodigio, habiendo completado más de 160 procedimientos con el uso de esta tecnología de vanguardia.',
      cta: {
        label: 'Ver artículo',
    ...
    {
      image: Blender4,
      title: 'Paciente de EE.UU. viaja a Puebla para cirugía de próstata',
