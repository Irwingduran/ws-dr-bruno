...
const Blog = () => {
    const article = [
        ...
        {id: 2, title: "¿Qué es HoLEP?", image: "https://www.e-consulta.com/_next/image?url=https%3A%2F%2Ffotos.e-consulta.com%2Fsite_uploads%2F2023%2FDiciembre%2Fbruno_rubi_urologo_prodigio_de_mexico_2.jpeg&w=1080&q=75", link: "https://hospitalesmac.com/blogt/2022/05/1197-holep.html"},
        ...
        {id: 5, title: "Considerado por Forbes como urólogo prodigio en América Latina.", image: "https://cdn.forbes.com.mx/2023/03/Bruno-Rubi%CC%81-Uro%CC%81logo1.jpg", link: "https://www.forbes.com.mx/ad-holep-la-tecnica-quirurgica-mas-avanzada-contra-el-crecimiento-prostatico/"},
        {id: 6, title: "Se inaugura el Centro Quirúrgico de Próstata en Puebla", image: "https://i0.wp.com/cincoradio.com.mx/wp-content/uploads/2023/12/oumT0msc78Y5Z23u.jpg?w=848&ssl=1", link: "https://cincoradio.com.mx/inauguran-centro-quirurgico-de-prostata-en-puebla-cirugias-sin-dolor-y-sin-sangrado/"},
        {id: 7, title: "Referencia nacional e internacional en cirugía de próstata por Forbes Latinoamérica.", image: img2, link: "https://forbes.com.mx/ad-bruno-rubi-christian-villeda-transforman-cirugia-de-prostata-en-mexico/"},
    ];
