...
const Blog = () => {
    const article = [
        ...
        {id: 3, title: "Cirujano alcanza 500 cirugías HoLEP mientras imparte curso en Colombia (Profesor Internacional)", image: img, link: "https://x.com/UroBruce/status/1862976059945213972"},
        {id: 4, title: "Considerado por Forbes como urólogo prodigio en América Latina.", image: "https://cdn.forbes.com.mx/2023/03/Bruno-Rubi%CC%81-Uro%CC%81logo1.jpg", link: "https://www.forbes.com.mx/ad-holep-la-tecnica-quirurgica-mas-avanzada-contra-el-crecimiento-prostatico/"},
