    ...
    <div className='px-4 lg:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver py-16'>
        <div className='flex items-center justify-center lg:w-2/5 mx-auto'>
            <div className='text-center'>
                <h2 className='lg:text-5x1 text-3x1 text-neutral-800 font-semibold mb-6 lg:leading-snug'>
                    Agenda una cita 
                </h2>
                <div className='flex items-center justify-center gap-8'>
                <a href="https://www.doctoralia.com.mx/bruno-rubi-lopez-2/urologo/puebla">
                    <button href="https://www.doctoralia.com.mx/bruno-rubi-lopez-2/urologo/puebla" className='btn-primary text-white'>Agendar
